...
Config.EnableOxInventory = true
Config.EnableQbInventory = true
...
-- Audit logging/webhook (leave empty to disable webhook)
Config.EnableAuditWebhook = false
Config.AuditWebhookURL = '' -- paste your webhook URL here

-- Audit logging to file (true writes a local audit log file)
Config.EnableAuditFileLog = true
Config.AuditLogFile = 'fridge_audit.log'

-- Validation limits
Config.MaxStorePerAction = 100 -- max items stored per action

-- DB options
Config.UseOxmysql = true -- use oxmysql if available; fallback to file if not
